...
// Query to get a random motivational quote
$query = "SELECT * FROM motivasi ORDER BY RAND() LIMIT 1";
$result = mysqli_query($db, $query);

if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    $konseler = htmlspecialchars($row['konseler']);
    $kata = htmlspecialchars($row['kata']);
} else {
    $konseler = "Admin";
    $kata = "Tidak ada kata motivasi saat ini.";
}
?>
<div class="flex flex-col gap-2 dark:text-white  w-full bg-white dark:bg-neutral-900 p-5 rounded-md mt-2 shadow-md mb-8">
    <div class="flex flex-row justify-between w-full">
        <div class="flex flex-row justify-between w-full">
            <div class="text-gray-600 dark:text-black text-2xl font-semibold">
                <?php echo $konseler; ?>
            </div>
    ...
    <div class="flex flex-row justify-between w-full">
        <div class="text-gray-900 dark:text-gray-700 font-sm">
            <i>Kata Motivasi</i>
        </div>
        <div class="text-xs">
    ...
    <div class="text-gray-700 dark:text-black mt-2">
